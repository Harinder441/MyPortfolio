...
from database import db, create_all, Bio, Education, LicenseCertification, Project, Experience, Award, Skill, UserMsg,sampledata
...
def user_data():
    form = request.form
    new_msg = UserMsg(email=form['email'], massage=form['massage'])
